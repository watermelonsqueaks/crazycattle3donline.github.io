...
<script type="text/javascript">
    ...
    })(window, document, "clarity", "script", "r55gri8k7c");
</script>

<body class="home page-template page-template-tmpl-page-home page-template-tmpl-page-home-php page page-id-2 scroll">
    <?php if ($enable_ads) : ?>
