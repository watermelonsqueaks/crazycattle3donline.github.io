            ...
            <?php if ($game_type === 'EXTERNAL' || ($game_type !== 'IFRAME_HTML'  && $check_load_now === false)) : ?>
                <div id="infor_box" class="facade-content">
                    <div class="facade-content-center">
                        ...
                        <img class="game-img" style="border-radius: 10px" src="<?php echo \helper\image::get_thumbnail($game->image, 200, 200, "m"); ?>" title="<?php echo $game_name; ?>" alt="<?php echo $game_name; ?>">
